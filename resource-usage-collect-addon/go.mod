module open-cluster-management.io/addon-contrib/resource-usage-collect-addon
...
require (
	...
	github.com/openshift/library-go v0.0.0-20240709124736-e97c4d72421f
	...
	open-cluster-management.io/sdk-go v0.14.1-0.20240704130151-d3c47c228d79
)
