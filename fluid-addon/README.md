...
1. Grant the work-agent on the managed cluster permission to manage the fluid resources.

```
# clusteradm create work permission-set -c cluster1 -f quick-start/work-agent-permision.yaml
```

2. Distribute fluid resources by manifestworks to the managed cluster.
