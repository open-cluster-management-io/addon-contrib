...
This repository contains the kueue addon controller and addon templates to deploy resources to hub and spoke clusters.
...
### Addon Template
- **Addon Template for hub:** To deploy [Kueue addon controllers](#kueue-addon-controller) on the hub.
- **Addon Template for spoke:** To deploy `ResourceFlavor`, `ClusterQueue` and `LocalQueue` resources need by MultiKueue to spoke clusters.
